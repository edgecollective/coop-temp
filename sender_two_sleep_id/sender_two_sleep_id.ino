...
#include <SPI.h>
#include <RH_RF95.h>
#include "ArduinoLowPower.h" //https://github.com/arduino-libraries/ArduinoLowPower.git
...
int wake_counter_max = 150; // for 10 min
int wake_counter = 0;

typedef struct {
  int           remoteID; //store this nodeId
  float         batt; //uptime in ms
...
theData.remoteID = remote_id;


if (j==0) {
  theData.temp1=celsius;
}
if (j==1) {

theData.temp2 = celsius;
